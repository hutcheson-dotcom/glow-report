...
Environment (set as GitHub secrets):
  ...
  GLOW_RESOURCE                         property name fragment or resourceId, if the account has several meters
"""
...
def main():
    ...
    if a.seed is None and seed_path.exists() and not DATA.exists():
        a.seed = seed_path
    if a.seed:
